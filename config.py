...
SAMPLING_FREQ	= 44100  # Sampling frequency of incoming audio (between 44100 and 48000)
...
LED_1_DMA        = 10      # DMA channel to use for generating signal (Between 1 and 14)(Pi 4 B. Found anything about 10 causes DMA error)
LED_1_BRIGHTNESS = 75      # Set to 0 for darkest and 255 for brightest
...
LED_2_DMA        = 9       # DMA channel to use for generating signal (Between 1 and 14)(Pi 4 B. Found anything about 10 causes DMA error)
LED_2_BRIGHTNESS = 75      # Set to 0 for darkest and 255 for brightest
